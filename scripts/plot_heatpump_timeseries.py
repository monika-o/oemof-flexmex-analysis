...
ax1.set_ylabel('Heat generation [GW]', fontsize = 20)
ax1.legend(fontsize = 15)

ax1.set_title('Heat generation by the small heat pump in relation to the COP', fontsize = 30)
plt.yticks(fontsize=15)
plt.savefig(os.path.join(os.path.dirname(__file__), '../results/240/Small_heatpump.png'), bbox_inches='tight')
plt.show()